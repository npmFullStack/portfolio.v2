...
const Portfolio = () => {
    ...
    const badgeStyles = {
        ...
        id: 1,
        title: "OCCConnect",
        description: "Real-time chat platform for OCC students to connect, match, and converse instantly with fellow students.",
        technologies: ["React", "Tailwind CSS", "Supabase", "PostgreSQL"],
        image: "/projects/occconnect.png",
        link: "https://occ-connect.vercel.app",
        badge: "Live"
    },
    {
        id: 2,
                        ...
                        <div className="absolute inset-0 pointer-events-none">
                            {[...Array(12)].map((_, i) => (
                                <div
                                    ...
                                    } opacity-20 animate-bounce opacity-60`}
                                    style={{
                                        left: `${20 + i * 10}%`,
                                        top: `${30 + (i % 3) * 20}%`,
    ...
    return (
        ...
        >
            ...
            <section
                id="home"
                className="relative min-h-screen flex items-center justify-center pt-20 px-4 sm:px-8 md:px-12 lg:px-24"
            >
                        ...
                        {projects.map(project => (
                            ...
                            >
                                <div className="relative h-48 bg-gradient-to-br from-green-400 to-green-600 flex items-center justify-center">
                                    ...
                                    {project.badge && (
                                        <span
                                            className={`absolute top-2 right-2 text-xs font-semibold px-2 py-1 rounded-full shadow ${
                                                badgeStyles[project.badge] || "bg-gray-500 text-white"
                                            }`}
                                        >
                                            {project.badge}
                                        </span>
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="flex justify-between items-center">
                                        ...
                                        <ExternalLink className="w-5 h-5 text-green-500 hover:text-green-400 flex-shrink-0 ml-2" />
                                    </div>
                                </div>
                            </a>
                        ))}
